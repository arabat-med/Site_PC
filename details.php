               ...
               <div id="productMain" class="row"><!-- row Begin -->
                   ...
                   <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Couleur</label>
                                   
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('must pick 1 color')"><!-- form-control Begin -->
                                          
                                           <option disabled selected>Select a Size</option>
                                           <option>Noire</option>
                                           <option>Argenter</option>
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Begin -->
                       <div class="box same-height headline"><!-- box same-height headline Begin -->
                           <h3 class="text-center">Produits susceptibles de vous intéresser</h3>
